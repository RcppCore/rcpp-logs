...
#load("~/git/rcpp-logs/results/result-20150304-134207.RData")
...
goodPkgs <-     c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
                  ...
                  "StMoSim", "stochvol", "stocks", "stosim", "strum", "survAccuracyMeasures", 
                  "surveillance", "survSNP", "SVMMatch", "synlik", "tagcloud", 
                  "TAM", "TAQMNGR", "tbart", "tcR", "TED", "textreg", "TFMPvalue", 
                  "timma", "tmg", "treeclim", "trustOptim", "tvd", "unmarked", 
                  "urltools", "V8", "VideoComparison", "VIM", "waffect", "wordcloud", 
                  "wsrf", "XBRL", "xergm", "zic",
                  "termstrc", "strataG")     # see below
...
badPkg <- c("FisHiCal", "HUM", "KernSmoothIRT", "lme4", "msgl"
            ...
            #"termstrc"    -- override: not reproducible
            )
