...
#load("~/git/rcpp-logs/results/result-20150908-215732.RData")
...
goodPkgs <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
              ...
              "iccbeta", "icensmis", "imager", "inarmix", "iptools", "IsingSampler", 
              "ISOpureR", "iterpc", "jaatha", "JacobiEigen", "JAGUAR", "jiebaR", 
              "kdecopula", "kergp", "KernSmoothIRT", "kmc", "Kmisc", "LaF", 
              "lamW", "Langevin", "lasvmR", "lbfgs", "lcopula", "lfl", "lifecontingencies", 
              ...
              "metafolio", "mets", "mev", "mgm", "mice", "minqa", "mirt", "mirtCAT", 
              ...
              "OpenMx", "openxlsx", "orQA", "packcircles", "PAFit", "pander", 
              "PanelCount", "partialAR", "pcalg", "pcIRT", "PedCNV", "pedometrics", 
              ...
              "RcppStreams", "RcppXts", "RcppZiggurat", "readstata13", "RealVAMS", 
              "reconstructr", "recosystem", "redist", "relSim", "remote", "ReorderCluster", 
              "repra", "resemble", "reshape2", "revealedPrefs", "rexpokit", 
              "rforensicbatwing", "rgam", "rgeolocate", "RInside", "ripa", 
              "rivr", "rkvo", "Rlibeemd", "RLRsim", "Rmalschains", "rmgarch", 
              "Rmixmod", "RmixmodCombi", "rncl", "robustgam", "robustHD", "robustreg", 
              "rococo", "rotations", "RoughSets", "roxygen2", "rpf", "Rphylopars", 
              "rplexos", "rPref", "RProtoBuf", "RQuantLib", "RSNNS", "RSNPset", 
              "RSofia", "Rsomoclu", "rstan", "rstpm2", "rtkpp", "Rtsne", "Ruchardet", 
              "rugarch", "Rvcg", "RVowpalWabbit", "saturnin", "sbmSDP", "SBSA", 
...
oldbadPkg <- c("miceadds", "optmatch", "rgeolocate", "rlme", "satellite")

badPkg <- c("dfcomb", "emil", "icd9", "miceadds", "optmatch",  
...
baddepends <- c(
    "emil",		# builds, bombs in examples: "‘there is no package called ‘pamr’"
...
badother <- c(
    ...
    "icd9",             # does not compile, ambigious overload for 'operator=='
    "optmatch",         # internal to package -- fails test
    "readr",            # fails to compile, ambigious overload for ‘operator!=’
    "readxl",           # fails to compile, ambigious overload for ‘operator!=’
    "rpg",              # does not compile, ambigious overload for 'operator=='
    "tidyr" 		# does not compile, ambigious overload for 'operator=='
    )
