...
#load("~/git/rcpp-logs/results/result-20150603-051503.RData")
...
goodPkgs <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
              ...
              "clusteval", "ClustMMDD", "ClustVarLV", "CMF", "CompGLM", "ConConPiWiFun", 
              ...
              "divo", "DNAprofiles", "DNAtools", "dslice", "DStree", "eive", 
              "emIRT", "EpiContactTrace", "ESGtoolkit", "evolqg", "EWGoF", 
              "fastGHQuad", "FastHCS", "fastM", "FastPCS", "FastRCS", "FBFsearch", 
              "fbroc", "fdaMixed", "FDGcopulas", "FDRreg", "FeatureHashing", 
              "fICA", "flip", "FLSSS", "forecast", "FRESA.CAD", "FSInteract", 
              "fugeR", "FunChisq", "fwsim", "gaselect", "GCPM", "gdm", "geiger", 
              "GENLIB", "geoCount", "glcm", "glmgraph", "GMCM", "Gmisc", "gMWT", 
              "GPareto", "GPlab", "GPvam", "graphicalVAR", "gRbase", "gRim", 
              "growcurves", "growfunctions", "GSE", "GUILDS", "GUTS", "GxM", 
              "h5", "haven", "hawkes", "HLMdiag", "hsphase", "httpuv", "hypervolume", 
              "iBATCGH", "IBHM", "iccbeta", "icd9", "icensmis", "inarmix", 
              ...
              "NAM", "ndl", "NetSim", "ngspatial", "NHMM", "NPBayesImpute", 
              "odeintr", "oem", "onlinePCA", "openair", "OpenMx", "openxlsx", 
              "orQA", "pander", "partialAR", "PBC", "pcalg", "PedCNV", "pedometrics", 
              "penMSM", "PerMallows", "phom", "phylobase", "planar", "plotSEMM", 
              "plyr", "poisDoubleSamp", "polywog", "PoweR", "PP", "PPtreeViz", 
              "PReMiuM", "propagate", "prospectr", "protViz", "pryr", "psd", 
              "psgp", "pvar", "QRM", "quadrupen", "quanteda", "quantspec", 
              "qVarSel", "Rankcluster", "rankdist", "rARPACK", "Rborist", "RcppAnnoy", 
              ...
              "Rlibeemd", "RLRsim", "Rmalschains", "rmgarch", "Rmixmod", "RmixmodCombi", 
              ...
              "stochvol", "stocks", "stosim", "strataG", "stream", "strum", 
              "survAccuracyMeasures", "surveillance", "survSNP", "SVMMatch", 
              "synlik", "systemicrisk", "tagcloud", "TAM", "TAQMNGR", "tcR", 
              "TED", "termstrc", "textreg", "TFMPvalue", "tmg", "treeclim", 
              "trustOptim", "tvd", "unmarked", "urltools", "V8", "VarSelLCM", 
              "VideoComparison", "VIM", "waffect", "wordcloud", "XBRL", "xergm", 
              "xml2", "zic")

#badPkg <- as.character(subset(res, res==1)[,1])
#dput(badPkg)

badPkg <- c("bcpa", "blockcluster", "dplyr", "ecp", "FisHiCal", "forestFloor", 
            "Funclustering", "GeneticTools", "HUM", "icamix", "KernSmoothIRT", 
            "lme4", "Morpho", "MRIaggr", "msgl", "nabor", "PAFit", "pROC", 
            "randomUniformForest", "Rclusterpp", "RcppRedis", "rlme", "tbart", 
            "timma", "wsrf")
...
badnotrcpp <- c(
    ...
    "blockcluster",	# fails to load RcppEigen
    "dplyr",            # builds, tests fail at "Error in library("Lahman") : there is no package called 'Lahman'"
    "ecp",		# fails: "Package suggested but not available for checking: ‘R.rsp’"
    ...
    "Funclustering",    # fails to load RcppEigen
    "GeneticTools",     # random fail on bad .tar.gz
    ...
    "PAFit",		# fails: "Package suggested but not available for checking: ‘R.rsp’"
    "pROC",		# buids, bombs in examples: "  Package logcondens not available, required with method='logcondens'."
    "randomUniformForest", # fails: Package suggested but not available for checking: ‘R.rsp’
    "Rclusterpp",	# fails to load RcppEigen
    "RcppRedis", 	# unclear, tests seem ok
    ...
    "timma", 		# fails: "Package suggested but not available for checking: ‘R.rsp’"
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
            ...
            "NHMM", "NPBayesImpute", "odeintr", "oem", "onlinePCA", "openair", 
            "OpenMx", "openxlsx", "orQA", "PAFit", "pander", "partialAR", 
            "PBC", "pcalg", "PedCNV", "pedometrics", "penMSM", "PerMallows", 
            "phom", "phylobase", "planar", "plotSEMM", "plyr", "poisDoubleSamp", 
            "polywog", "PoweR", "PP", "PPtreeViz", "PReMiuM", "pROC", "propagate", 
            ...
            "RcppEigen", "RcppExamples", "RcppGSL", "RcppMLPACK", "RcppOctave", 
            ...
            "RQuantLib", "RSNNS", "RSNPset", "RSofia", "Rsomoclu", "rtkpp", 
            "Rtsne", "Ruchardet", "rugarch", "Rvcg", "RVowpalWabbit", "SBSA", 
            "scrm", "scrypt", "sdcMicro", "sdcTable", "SEERaBomb", "segmag", 
            "seismicRoll", "SelvarMix", "sequences", "sgd", "sglOptim", "simFrame", 
