...
#load("~/git/rcpp-logs/results/result-20150628-190933.RData")
#goodPkgs <- as.character(subset(res, res==0)[,1])
#dput(goodPkgs)

goodPkgs <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr",
              "Amelia", "apcluster", "ASPBay", "BalancedSampling", "BayesComm",
              "BayesFactor", "bayesm", "bayou", "bcp", "bfa", "bfp", "bifactorial",
              "BIFIEsurvey", "blockcluster", "blockmodels", "brms", "btf", "bvarsv",
              ...
              "Coxnet", "Crossover", "dbmss", "ddalpha", "Delaporte",
              "dendextendRcpp", "DepthProc", "DetMCD", "dfcomb", "dfmta", "dils",
              "disclapmix", "diversitree", "diveRsity", "divo", "DNAprofiles",
              "DNAtools", "dslice", "DStree", "ecp", "EditImputeCont", "eive",
              "emIRT", "EpiContactTrace", "ESGtoolkit", "evolqg", "EWGoF",
              "fastGHQuad", "FastHCS", "fastM", "FastPCS", "FastRCS", "FBFsearch",
              "fbroc", "fdaMixed", "FDGcopulas", "FDRreg", "FeatureHashing", "fICA",
              "flam", "flip", "FLSSS", "forecast", "FRESA.CAD", "FSInteract",
              "fugeR", "FunChisq", "Funclustering", "fwsim", "gaselect", "GCPM",
              "gdm", "geiger", "GeneticTools", "GENLIB", "geoCount", "glcm",
              "glmgraph", "GMCM", "Gmisc", "gMWT", "GPareto", "GPvam",
              ...
              "jaatha", "JAGUAR", "jiebaR", "kdecopula", "kergp", "kmc", "Kmisc",
              "LaF", "lamW", "lbfgs", "lfl", "lifecontingencies", "lm.br", "lpme",
              "lsbclust", "lsgl", "Luminescence", "marked", "markovchain", "MAT",
              "matchingMarkets", "matchingR", "maxent", "mbbefd", "mcIRT",
              "metafolio", "mets", "mice", "miceadds", "minqa", "mirt", "mirtCAT",
              "miscF", "miscset", "MixAll", "mixedMem", "mkde", "mlxR", "mmand",
              "mp", "Mposterior", "MPTinR", "MTS", "multicool", "mvabund", "MVB",
              "mvnfast", "mwaved", "myTAI", "NAM", "ndl", "NetSim", "ngspatial",
              "NHMM", "nonlinearTseries", "NPBayesImpute", "oapackage", "odeintr",
              "oem", "onlinePCA", "openair", "OpenMx", "openxlsx", "orQA", "PAFit",
              ...
              "RcppProgress", "RcppRoll", "RcppSMC", "RcppStreams", "RcppTOML",
              ...
              "robustreg", "rococo", "rotations", "RoughSets", "roxygen2", "rpf",
              "rpg", "Rphylopars", "rplexos", "rPref", "RProtoBuf", "RQuantLib",
              "RSNNS", "RSNPset", "RSofia", "Rsomoclu", "rtkpp", "Rtsne",
              "Ruchardet", "rugarch", "Rvcg", "RVowpalWabbit", "sbmSDP", "SBSA",
              "scales", "scrm", "scrypt", "sdcMicro", "sdcTable", "SEERaBomb",
              "segmag", "seismicRoll", "SelvarMix", "sequences", "sgd", "sglOptim",
              "simFrame", "simPop", "sirt", "slfm", "SLOPE", "snipEM", "snplist",
              "SocialNetworks", "SOD", "spacodiR", "spaMM", "sparseHessianFD",
              "sparseLTSEigen", "SpatialEpi", "SpatialTools", "SpatPCA",
              "spBayesSurv", "staTools", "StereoMorph", "StMoSim", "stochvol",
              "stocks", "stosim", "stream", "strum", "survAccuracyMeasures",
              "surveillance", "survSNP", "SVMMatch", "synlik", "systemicrisk",
              "tagcloud", "TAM", "TAQMNGR", "tcR", "TED", "termstrc", "TESS",
              "textreg", "TFMPvalue", "timma", "tmg", "treeclim", "trustOptim",
              "tvd", "unmarked", "urltools", "V8", "VarSelLCM", "VideoComparison",
              "VIM", "waffect", "wordcloud", "XBRL", "xergm", "xml2", "zic",
              "BIPOD",   # spurious fail
              "strataG") # ditto
...
oldbadPkg <- c("bcpa", "dplyr", "FisHiCal", "forestFloor", "HUM", "icamix", 
               "KernSmoothIRT", "lme4", "Morpho", "MRIaggr", "msgl", 
               "nabor", "pROC", "RcppRedis", "rlme", "tbart", "wsrf")
badPkg <- c("BaBooN", "bcpa", "dplyr", "FisHiCal", "forestFloor", 
            "HUM", "icamix", "KernSmoothIRT", "lme4", "missDeaths", "Morpho", 
            "MRIaggr", "msgl", "nabor", "pROC", "RcppRedis", "rlme", 
            "tbart", "wsrf")
...
badnotrcpp <- c(
    ...
    "missDeaths",	# does NOT build, issue with R_xlen_t
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
            "apcluster", "ASPBay", "BaBooN", "BalancedSampling", "BayesComm", 
            ...
            "ClustMMDD", "ClustVarLV", "CMF", "CompGLM", "ConConPiWiFun", 
            ...
            "ecp", "EditImputeCont", "eive", "emIRT", "EpiContactTrace", 
            ...
            "fugeR", "FunChisq", "Funclustering", "fwsim", "gaselect", "GCPM", 
            "gdm", "geiger", "GeneticTools", "GENLIB", "geoCount", "glcm", 
            "glmgraph", "GMCM", "Gmisc", "gMWT", "GPareto", "GPvam", "graphicalVAR", 
            ...
            "KernSmoothIRT", "kmc", "Kmisc", "LaF", "lamW", "lbfgs", "lfl", 
            "lifecontingencies", "lm.br", "lme4", "lpme", "lsbclust", "lsgl", 
            "Luminescence", "marked", "markovchain", "MAT", "matchingMarkets", 
            ...
            "Morpho", "mp", "Mposterior", "MPTinR", "MRIaggr", "msgl", "MTS", 
            "multicool", "mvabund", "MVB", "mvnfast", "mwaved", "myTAI", 
            "nabor", "NAM", "ndl", "NetSim", "ngspatial", "NHMM", "nonlinearTseries", 
            "NPBayesImpute", "oapackage", "odeintr", "oem", "onlinePCA", 
            "openair", "OpenMx", "openxlsx", "orQA", "PAFit", "pander", "partialAR", 
            "PBC", "pcalg", "PedCNV", "pedometrics", "penMSM", "PerMallows", 
            "phom", "phylobase", "planar", "plotSEMM", "plyr", "poisDoubleSamp", 
            ...
            "Rankcluster", "rankdist", "rARPACK", "Rborist", "Rclusterpp", 
            ...
            "RVowpalWabbit", "sbmSDP", "SBSA", "scales", "scrm", "scrypt", 
            ...
            "wordcloud", "wsrf", "XBRL", "xergm", "xml2", "zic")
