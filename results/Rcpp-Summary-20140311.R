...
## -- started with Rcpp 0.11.0.4 (current on GitHub as of 2014-Mar-08)
##    as well as current RcppArmadillo and RcppEigen)
##
##    note that IBHM, RVowpalWabbit, trustOptim appeared to fail for an
##    unclear / spurious reason

#load("~/git/rcpp-logs/results/result-20140311-013258.RData")
...
goodPkg <- c("accelerometry", "acer", "AdaptiveSparsity", "ALKr", "Amelia", 
             ...
             "HLMdiag", "hsphase", "httpuv", "HUM", "hypervolume", "IBHM", "inarmix", 
             "IsingSampler", "jaatha", "KernSmoothIRT", "kmc", "Kmisc", "LaF", 
             "lm.br", "marked", "maxent", "mets", "mice", "miceadds", "minqa", 
             "mirt", "miscF", "MPTinR", "MTS", "mvabund", "MVB", "ndl", "NetSim", 
             "ngspatial", "oem", "OmicKriging", "openair", "orQA", "PBC", 
             "pcalg", "PedCNV", "phom", "phylobase", "planar", "plyr", "PReMiuM", 
             "pROC", "propagate", "prospectr", "protViz", "psgp", "Rankcluster", 
             ...
             "RcppSMC", "RcppXts", "RcppZiggurat", "rexpokit", "rforensicbatwing", 
             "rgam", "RInside", "Rmalschains", "RMessenger", "rmgarch", "Rmixmod", 
             "robustgam", "robustHD", "rococo", "rotations", "roxygen2", "RProtoBuf", 
             "RQuantLib", "RSNNS", "RSofia", "Ruchardet", "rugarch", "Rvcg", "RVowpalWabbit", 
             ...
             "survSNP", "TAM", "TAQMNGR", "tbart", "termstrc", "tvm", "trustOptim", "unmarked", 
