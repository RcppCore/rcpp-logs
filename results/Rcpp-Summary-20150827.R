...
#load("~/git/rcpp-logs/results/result-20150827-174044.RData")
...
goodPkgs <-c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
             ...
             "divo", "DNAprofiles", "DNAtools", "DStree", "ecp", "EditImputeCont", 
             "eive", "emIRT", "EPGLM", "ESGtoolkit", "EstHer", "evolqg", "EWGoF", 
             ...
             "gkmSVM", "glcm", "glmgraph", "GMCM", "Gmisc", "gMWT", "GPvam", 
             ...
             "lfl", "lifecontingencies", "lm.br", "lpme", "lsbclust", "lsgl", 
             "Luminescence", "marked", "markophylo", "MAT", "matchingMarkets", 
             "matchingR", "maxent", "mbbefd", "mcemGLM", "mcIRT", "metafolio", 
             "mets", "mev", "mice", "minqa", "mirt", "mirtCAT", "miscF", "miscset", 
             ...
             "primes", "propagate", "prospectr", "protViz", "pryr", "psd", 
             ...
             "RcppClassicExamples", "RcppCNPy", "RcppDL", "RcppEigen", "RcppExamples", 
...
baddepends <- c(
    ...
    "lme4",             # builds, bombs in tests: "there is no package called ‘PKPDmodels’ ‘MEMSS’ ‘gamm4’ ‘HSAUR2’
    "markovchain",      # builds, bombs in tests: "there is no package called ‘diagram’ ‘DiagrammeR’
    ...
    "MRIaggr",          # builds, bombs in examples: "requires to have installed the oro.nifti package" ‘oro.dicom’ ‘oro.nifti’ ‘mritc’ ‘RANN’
...
badnotrcpp <- c(
    "dslice",           # internal to package:   namespace ‘scales’ is imported by ‘ggplot2’ so cannot be unloaded
    "msgl",  	        # builds, test tolerance too low; msgl fails on stop() in one of its tests
    "optmatch",         # internal to package -- fails test 
    "RcppDE",		# internal to package -- segfaults
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
            ...
            "packcircles", "PAFit", "pander", "partialAR", "pcalg", "pcIRT", 
