...
#load("~/git/rcpp-logs/results/result-20150208-023951.RData")
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
            ...
            "StMoSim", "StochKit2R", "stochvol", "stosim", "strataG", "strum", 
            "survAccuracyMeasures", "surveillance", "survSNP", "SVMMatch", 
            "synlik", "tagcloud", "TAM", "tbart", "tcR", "TED", "termstrc", 
            "textreg", "TFMPvalue", "timma", "treeclim", "trustOptim", "tvd", 
            "unmarked", "urltools", "V8", "VideoComparison", "VIM", "waffect", 
