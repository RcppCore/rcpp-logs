...
## start with Rcpp 0.11.2.4 and RcppArmadillo 0.4.419.3.0
...
goodPkg <- c("AdaptiveSparsity", "Amelia", "BayesComm", "bayou", "bfa", 
             ...
             "lsgl", "mcIRT", "metafolio", "mets", "miceadds", "miscF", "mmand", 
             "Mposterior", "MVB", "mvnfast", "ngspatial", "oem", "pcalg", 
             "PedCNV", "planar", "prospectr", "psgp", "quadrupen", "rcppbugs", 
             "RcppDE", "RcppMLPACK", "RcppRoll", "resemble", "revealedPrefs", 
             "rgam", "rmgarch", "robustgam", "robustHD", "rotations", "rugarch", 
             "SBSA", "SelvarMix", "sglOptim", "sirt", "slfm", "SpatialEpi", 
