...
#load("~/git/rcpp-logs/results/result-20150716-140258.RData")
...
goodPkgs <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
              ...
              "btf", "bvarsv", "CARBayes", "CARBayesST", "ccaPP", "cccp", "cda", 
              "CDM", "cgAUC", "chopthin", "CIDnetworks", "cladoRcpp", "classify", 
              "clere", "climdex.pcic", "clogitL1", "clusteval", "ClustMMDD", 
              "ClustVarLV", "CMF", "coala", "CompGLM", "ConConPiWiFun", "coneproj", 
              "copCAR", "CorReg", "Coxnet", "Crossover", "dbmss", "ddalpha", 
              "Delaporte", "dendextendRcpp", "DepthProc", "DetMCD", "dfcomb", 
              "dfmta", "dils", "disclapmix", "diversitree", "diveRsity", "divo", 
              "DNAprofiles", "DNAtools", "dslice", "DStree", "ecp", "EditImputeCont", 
              "eive", "emIRT", "ESGtoolkit", "evolqg", "EWGoF", "fastGHQuad", 
              ...
              "mkde", "mlxR", "mp", "Mposterior", "MPTinR", "MTS", "multicool", 
              "mvabund", "MVB", "mvnfast", "mwaved", "myTAI", "NAM", "ndl", 
              "NetSim", "neuroim", "ngspatial", "NHMM", "nonlinearTseries", 
              "NPBayesImpute", "oapackage", "odeintr", "oem", "OneArmPhaseTwoStudy", 
              "onlinePCA", "openair", "OpenMx", "openxlsx", "orQA", "PAFit", 
              "pander", "partialAR", "pcalg", "PedCNV", "pedometrics", "penMSM", 
              "PerMallows", "phylobase", "planar", "plotSEMM", "poisDoubleSamp", 
              ...
              "RcppOctave", "RcppProgress", "RcppRoll", "RcppSMC", "RcppStreams", 
              ...
              "Rtsne", "Ruchardet", "rugarch", "Rvcg", "RVowpalWabbit", "sbmSDP", 
              "SBSA", "scales", "scrm", "scrypt", "sdcMicro", "sdcTable", "SEERaBomb", 
              "segmag", "seismicRoll", "SelvarMix", "sequences", "sgd", "sglOptim", 
              "signalHsmm", "simFrame", "simPop", "sirt", "slfm", "SLOPE", 
              "snipEM", "snplist", "SocialNetworks", "SOD", "spacodiR", "spaMM", 
              "sparseHessianFD", "sparseLTSEigen", "SpatialEpi", "SpatialTools", 
              "SpatPCA", "spBayesSurv", "spduration", "spsann", "staTools", 
...
badPkg <- c("BaBooN", "bcpa", "dplyr", "FisHiCal", "forestFloor", "GPareto", 
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
            ...
            "ecp", "EditImputeCont", "eive", "emIRT", "ESGtoolkit", "evolqg", 
            "EWGoF", "fastGHQuad", "FastHCS", "fastM", "FastPCS", "FastRCS", 
            "FBFsearch", "fbroc", "FCNN4R", "fdaMixed", "FDGcopulas", "FDRreg", 
            "FeatureHashing", "fICA", "FisHiCal", "flam", "flip", "FLSSS", 
            "forecast", "forestFloor", "FRESA.CAD", "FSInteract", "fugeR", 
            "FunChisq", "Funclustering", "fwsim", "gaselect", "GCPM", "gdm", 
            "geiger", "GeneticTools", "GENLIB", "geoCount", "gkmSVM", "glcm", 
            ...
            "ISOpureR", "iterpc", "jaatha", "JAGUAR", "jiebaR", "kdecopula", 
            "kergp", "KernSmoothIRT", "kmc", "Kmisc", "LaF", "lamW", "lbfgs", 
            "lfl", "lifecontingencies", "lm.br", "lme4", "lpme", "lsbclust", 
            "lsgl", "Luminescence", "marked", "markophylo", "markovchain", 
            "MAT", "matchingMarkets", "matchingR", "maxent", "mbbefd", "mcIRT", 
            "metafolio", "mets", "mice", "miceadds", "minqa", "mirt", "mirtCAT", 
            "miscF", "miscset", "missDeaths", "MixAll", "mixedMem", "mkde", 
            "mlxR", "mmand", "Morpho", "mp", "Mposterior", "MPTinR", "MRIaggr", 
            ...
            "oem", "OneArmPhaseTwoStudy", "onlinePCA", "openair", "OpenMx", 
            ...
            "VIM", "waffect", "wordcloud", "wsrf", "XBRL", "xergm", "xml2", 
            "zic")
