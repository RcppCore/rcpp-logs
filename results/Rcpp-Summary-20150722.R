...
#load("~/git/rcpp-logs/results/result-20150722-020450.RData")
...
goodPkgs <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
              ...
              "BIFIEsurvey", "BIPOD", "blockcluster", "blockmodels", "btf", 
              "bvarsv", "CARBayes", "CARBayesST", "ccaPP", "cccp", "cda", "CDM", 
              ...
              "rARPACK", "raster", "Rborist", "Rclusterpp", "RcppAnnoy", "RcppAPT", 
              ...
              "RcppRedis", "RcppRoll", "RcppSMC", "RcppStreams", "RcppTOML", 
              ...
              "spacodiR", "spaMM", "sparseHessianFD", "sparseLTSEigen", "sparsereg", 
              ...
              "TAM", "TAQMNGR", "tcR", "TED", "termstrc", "TESS", "textreg", 
              "TFMPvalue", "timma", "tmg", "treeclim", "trustOptim", "tvd", 
              "unmarked", "urltools", "V8", "VarSelLCM", "VideoComparison", 
              "VIM", "waffect", "webreadr", "wordcloud", "XBRL", "xergm", "xml2", 
              "zic",
              ## spurious
              "brms", "mmand", "strataG")
...
oldbadPkg <- c("BaBooN", "bcpa", "cccp", "dplyr", "FisHiCal", "forestFloor", 
