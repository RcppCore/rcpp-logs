...
#load("~/git/rcpp-logs/results/result-20150826-145003.RData")
...
goodPkgs <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
              ...
              "BayesComm", "BayesFactor", "bayesm", "bayou", "bcp", "bfa", 
              ...
              "EditImputeCont", "eive", "emIRT", "EPGLM", "ESGtoolkit", "EstHer", 
              "evolqg", "EWGoF", "fastGHQuad", "FastGP", "FastHCS", "fastM", 
              ...
              "geoCount", "GERGM", "gkmSVM", "glcm", "glmgraph", "GMCM", "Gmisc", 
              "gMWT", "GPvam", "graphicalVAR", "gRbase", "gRim", "growcurves", 
              "growfunctions", "GSE", "GUILDS", "GUTS", "GxM", "h5", "haven", 
              "hawkes", "HLMdiag", "hsphase", "hts", "httpuv", "HUM", "hypervolume", 
              ...
              "Kmisc", "LaF", "lamW", "lasvmR", "lbfgs", "lcopula", "lfl", 
              "lifecontingencies", "lm.br", "lpme", "lsbclust", "lsgl", "Luminescence", 
              "marked", "markophylo", "MAT", "matchingMarkets", "matchingR", 
              "maxent", "mbbefd", "mcemGLM", "mcIRT", "metafolio", "mets", 
              "mev", "mice", "minqa", "mirt", "mirtCAT", "miscF", "miscset", 
              "missDeaths", "MixAll", "mixedMem", "mkde", "mlxR", "Morpho", 
              "mp", "Mposterior", "MPTinR", "MTS", "multicool", "mvabund", 
              "MVB", "mvnfast", "mwaved", "myTAI", "NAM", "ndl", "NetSim", 
              ...
              "PAFit", "pander", "partialAR", "pcalg", "pcIRT", "PedCNV", "pedometrics", 
              "penMSM", "PerMallows", "planar", "plotSEMM", "plyr", "poisDoubleSamp", 
              ...
              "stosim", "stream", "strum", "survAccuracyMeasures", "surveillance", 
              "survSNP", "SVMMatch", "synlik", "systemicrisk", "tagcloud", 
              "TAM", "TAQMNGR", "tcR", "TED", "TESS", "textreg", "TFMPvalue", 
              "timma", "tmg", "treeclim", "trustOptim", "tvd", "unmarked", 
              "urltools", "V8", "VarSelLCM", "VideoComparison", "VIM", "waffect", 
              "walkr", "webreadr", "wordcloud", "XBRL", "xergm", "xml2", "yakmoR", 
              "zic",
              ## spurious
              "FastBandChol",           # was missing a proper src/Makefile, new version ok
              "mmand", "termstrc")

#badPkg <- as.character(subset(res, res==1)[,1])
#dput(badPkg)

oldbadPkg <- c("BaBooN", "bcpa", "dplyr", "FisHiCal", "forestFloor", 
               "GPareto", "HUM", "icamix", "KernSmoothIRT", "lme4", "miceadds", 
               "missDeaths", "Morpho", "MRIaggr", "msgl", "nabor", 
               "PBC", "pROC", "rlme", "tbart", "wsrf")

badPkg <- c("bcpa", "dplyr", "GPareto", "lme4", "markovchain", 
            "mcmcse", "miceadds", "MRIaggr", "msgl", "nabor", "optmatch", 
            "phylobase", "pROC", "rlme", "satellite", "strataG", "tbart", 
            "wsrf")
...
badnotrcpp <- c(
    ...
    "markovchain",      # builds, bombs in tests: "there is no package called 'diagram'"
    "mcmcse",		# builds, bombs in tests: "there is no package called 'mAr'"
    ...
    "optmatch",         # fails test
    "phylobase",        # did not build: "Package required and available but unsuitable version: ‘rncl’"
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "AHR", "algstat", "ALKr", 
            ...
            "hts", "httpuv", "HUM", "hypervolume", "iBATCGH", "IBHM", "icamix", 
            "iccbeta", "icd9", "icensmis", "inarmix", "iptools", "IsingSampler", 
            "ISOpureR", "iterpc", "jaatha", "JacobiEigen", "JAGUAR", "jiebaR", 
            "kdecopula", "kergp", "KernSmoothIRT", "kmc", "Kmisc", "LaF", 
            "lamW", "lasvmR", "lbfgs", "lcopula", "lfl", "lifecontingencies", 
            "lm.br", "lme4", "lpme", "lsbclust", "lsgl", "Luminescence", 
            "marked", "markophylo", "markovchain", "MAT", "matchingMarkets", 
            "matchingR", "maxent", "mbbefd", "mcemGLM", "mcIRT", "mcmcse", 
            "metafolio", "mets", "mev", "mice", "miceadds", "minqa", "mirt", 
            "mirtCAT", "miscF", "miscset", "missDeaths", "MixAll", "mixedMem", 
            ...
            "PAFit", "pander", "partialAR", "pcalg", "pcIRT", "PedCNV", "pedometrics", 
            "penMSM", "PerMallows", "phylobase", "planar", "plotSEMM", "plyr", 
            "poisDoubleSamp", "polywog", "PoweR", "PP", "PPtreeViz", "PReMiuM", 
            "primes", "pROC", "propagate", "prospectr", "protViz", "pryr", 
            "psd", "psgp", "pvar", "QRM", "quadrupen", "quanteda", "quantspec", 
            "qVarSel", "randomUniformForest", "ranger", "Rankcluster", "rankdist", 
            "rARPACK", "raster", "Rblpapi", "Rborist", "Rclusterpp", "RcppAnnoy", 
            ...
            "RcppProgress", "RcppRedis", "RcppRoll", "RcppShark", "RcppSMC", 
            ...
            "rgam", "rgeolocate", "RInside", "ripa", "rivr", "rkvo", "Rlibeemd", 
            ...
            "spacodiR", "spaMM", "SparseFactorAnalysis", "sparseHessianFD", 
            "sparseLTSEigen", "sparsereg", "SpatialEpi", "SpatialTools", 
            "SpatPCA", "spBayesSurv", "spduration", "spsann", "StatMethRank", 
            "staTools", "StereoMorph", "stm", "StMoSim", "stochvol", "stocks", 
