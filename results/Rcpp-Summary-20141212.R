...
#load("~/git/rcpp-logs/results/result-20141213-040145.RData")
...
goodPkg <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
             ...
             "FLSSS", "forecast", "fugeR", "Funclustering", "fwsim", "GCPM", 
             ...
             "jiebaR", "kmc", "Kmisc", "LaF", "lbfgs", "lm.br", "lsgl", "marked", 
             "MAT", "matchingMarkets", "maxent", "mcIRT", "metafolio", "mets", 
             "mice", "miceadds", "minqa", "mirt", "miscF", "miscset", "mkde", 
             "mmand", "mp", "Mposterior", "MPTinR", "MTS", "mvabund", "MVB", 
             "mvnfast", "mwaved", "myTAI", "ndl", "NetSim", "ngspatial", "NHMM", 
             "NPBayesImpute", "oem", "OneArmPhaseTwoStudy", "openair", "openxlsx", 
             "orQA", "pander", "PBC", "pcalg", "PedCNV", "pedometrics", "PerMallows", 
             ...
             "StereoMorph", "StMoSim", "stochvol", "stosim", "survAccuracyMeasures", 
             "surveillance", "survSNP", "synlik", "tagcloud", "TAM", "tcR", 
             "TED", "termstrc", "TFMPvalue", "timma", "treeclim", "trustOptim", 
             "tvd", "unmarked", "urltools", "VideoComparison", "VIM", "waffect", 
             "wordcloud", "XBRL", "zic")
...
badPkg <- c("bcpa", "CARBayes", "climdex.pcic", "cqrReg", "dplyr", "FisHiCal", 
            "HUM", "icamix", "KernSmoothIRT", "lme4", "lpme", "Morpho", "msgl", 
            "nabor", "pROC", "randomUniformForest", "RcppCNPy", "repra", 
            "revealedPrefs", "rplexos", "rPref", "spBayesSurv", "strum", 
            "tbart", "textreg", "V8", "wsrf")
    
#nolongerbad <- setdiff(prevbadPkg, badPkg)
nolongerbad <- c(
    #"gRbase", "jaatha", "mirt", "sirt","TAM")
...
passedAfterPatch <- c(
    ...
    "V8")              # missing libv8-dev; passes once install

## lpme:           const issue, patches in two lines
## climdex.pcic    const issue, patch in one line
## spBayesSurv     const issue, patch in two lines
...
allPkg <- c("accelerometry", "AdaptiveSparsity", "algstat", "ALKr", "Amelia", 
            ...
            "GMCM", "gMWT", "GPvam", "gRbase", "gRim", "growcurves", "growfunctions", 
            "GSE", "GUILDS", "GUTS", "GxM", "hawkes", "HDPenReg", "HLMdiag", 
            ...
            "ngspatial", "NHMM", "NPBayesImpute", "oem", "OneArmPhaseTwoStudy", 
